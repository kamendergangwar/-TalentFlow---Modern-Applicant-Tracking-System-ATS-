...
const ShareJobDialog = ({ jobTitle, companyName = "TalentFlow", jobId }: ShareJobDialogProps) => {
    ...
    const shareLinks = [
        ...
        {
            name: "Email",
            url: `mailto:?subject=${encodeURIComponent(`Job Opportunity: ${jobTitle}`)}&body=${encodeURIComponent(shareText)}`,
        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Share this job posting on social media or copy the link.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid grid-cols-2 gap-3 py-4">
                    {shareLinks.map((link) => (
                        <a
                            ...
                            className={`flex items-center justify-center gap-2 p-3 rounded-md text-white transition-colors ${link.color}`}
                        >
                            {link.icon}
                ...
                <p className="text-xs text-muted-foreground mt-2">
                    For Instagram, Naukri, and other platforms, please copy the link above.
                </p>
            </DialogContent>
        </Dialog>
    );
